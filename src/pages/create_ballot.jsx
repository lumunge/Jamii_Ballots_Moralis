...
import map from "../../Truffle/build/map.json";
...
const create_ballot = () => {
  ...
  const load_contract = async (chain, contract_name) => {
    ...
    try {
      contract_artifact = await import(`../contracts/JamiiFactory.json`);
      console.log(contract_artifact);
      console.log("CONNECTED #8");
    } catch (e) {
      console.log(
        `Failed to load contract artifact "../contracts/JamiiFactory.json"`
      );
